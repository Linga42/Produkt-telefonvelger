...
window.PV.Telefon = (function () {
  ...
  function byggWidget(rot, VARIANTER, MODELLBILDER) {
    ...
    function velgModell(modell) {
      ...
      lagKnapper('tk-kapasitet', unike(filtrer(), 'kapasitet'), velgKapasitet, false);
    ...
    function velgKapasitet(kapasitet) {
      ...
      lagKnapper('tk-farge', filtrer(), velgFarge, true);
    ...
    function velgFarge(variant) {
      ...
      var bilder = (typeof MODELLBILDER !== 'undefined') ? MODELLBILDER : {};
      visBilde(variant.bilde || bilder[valg.modell] || '', variant.modell + ' ' + variant.farge);
